...
>>>>>>> a969769cb492248d7e1942de8d5b28a35d0c3858
...
+ Dialer: Student added to automated dialer campaign. Task created in Unify to let Admissions Counselor know that student is part of the dialer.
...
+ __Overall Results as of 3/8/21:__ 
  ...
  - FAFSA Completion Rate for the **Dialer + Funding Task** test group was **0.7 percentage points lower (-3.4% change)**. This difference is not statistically significant at 95% confidence.
  ...
  - FAFSA Completion Rate for the **Funding Task Only** test group was **2.2 percentage points higher (10.2% change)**. This difference is not statistically significant at 95% confidence. 
  
  See [appendix](#stats) for more detail on how to interpret the results.


```{r echo=FALSE, out.width = "100%", fig.align='center'}
knitr::include_graphics(here::here("imgs/nofafsa_21EW4_overall_20210323_repop.png", ""))
```
...
<br>
```{r echo=FALSE, out.width = "100%", fig.align='center'}
knitr::include_graphics(here::here("imgs/nofafsa_21EW4_melt_20210323_repop.png", ""))
```
<br>
...
```{r echo=FALSE, out.width = "100%", fig.align='center'}
knitr::include_graphics(here::here("imgs/nofafsa_21EW4_overall_20210323_orgpop.png", ""))
```
<br>
